...
app.controller('MainCtrl', function($scope, $resource, $filter) {
  ...
  ComMode = (function(superClass) {
    extend(ComMode, superClass);
    ...
    function ComMode() {
      this.removeUnit = bind(this.removeUnit, this);
      this.addUnit = bind(this.addUnit, this);
      ComMode.__super__.constructor.call(this, "ComMode");
      angular.forEach(this.statDefs, (function(_this) {
  ...
  FacMode = (function(superClass) {
    extend(FacMode, superClass);
    ...
    function FacMode() {
      this.updateCurrentFields = bind(this.updateCurrentFields, this);
    ...
    FacMode.prototype.updateCurrentFields = function() {
      return angular.forEach(this.statDefs, (function(_this) {
        return function(obj, k) {
          if (obj.active) {
            return _this.currentFields[k] = obj.str;
          } else {
